<div class="mb-3">
    <label for="imageProduct" class="block text-base font-medium text-gray-700 mb-3">Image<span class="pl-1 text-red-500">*</span></label>
    ...
    <!-- Modal !==  -->
    <div
        class="fixed inset-0 z-50 w-full h-1/2 md:w-3/6 m-auto flex items-center justify-center">
        ...
        <div class="bg-white p-4 z-20 rounded w-full h-full">
            ...
            <div x-data="{ activeTab: 'tab1' }" class="w-full h-2/3">
                <ul class="flex text-center border">
                    <li @click="activeTab = 'tab1'" :class="{ 'bg-gray-800 text-white': activeTab === 'tab1' }" class="py-2 border-r">
                        <a href="#" class="py-4 px-8">Uploaded From Browser</a>
                    </li>
                    <li @click="activeTab = 'tab2'" :class="{ 'bg-gray-800 text-white': activeTab === 'tab2' }" class="py-2 border-r">
                        <a href="#" class="py-4 px-8">Url</a>
                    </li>
                </ul>
